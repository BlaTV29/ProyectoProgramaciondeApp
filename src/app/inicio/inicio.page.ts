...
export class InicioPage implements OnInit {
  ...
  clases: any[] = [
    { nombre: 'ARQUITECTURA', seccion: 'ASY4131-012V', sala: 'V210', profesor: 'Guillermo ', mostrarAsistencia: false, asistencias: [] },
    { nombre: 'CALIDAD DE SOFTWARE', seccion: 'CSY4111-009V', sala: 'V011', profesor: 'DIEGO PATRICIO OCARES GONZALEZ', mostrarAsistencia: false, asistencias: [] },
    { nombre: 'ESTADÍSTICA DESCRIPTIVA', seccion: 'MAT4140-003V', sala: 'V211', profesor: 'KATHERINE DEL CARMEN ENCINA ALARCON', mostrarAsistencia: false, asistencias: [] },
    { nombre: 'INGLÉS INTERMEDIO', seccion: 'INI5111-030V', sala: 'V219', profesor: 'JUAN PABLO LEYTON LARA', mostrarAsistencia: false, asistencias: [] },
    { nombre: 'PROCESO DE PORTAFOLIO FINAL', seccion: 'PY41447-005V', sala: 'V110', profesor: 'PATRICIO ANDRES SOTO SERDIO', mostrarAsistencia: false, asistencias: [] },
    { nombre: 'PROGRAMACIÓN DE APLICACIONES MÓVILES', seccion: 'PGY4121-010V', sala: 'V311', profesor: 'DIEGO PATRICIO OCARES GONZALEZ', mostrarAsistencia: false, asistencias: [] },
    { nombre: 'ÉTICA PARA EL TRABAJO', seccion: 'EAY4450-002V', sala: 'F103', profesor: 'ESTEBAN SALVATIERRA ROMAN', mostrarAsistencia: false, asistencias: [] },
